...
declare module 'vue' {
  export interface GlobalComponents {
    AppErrorDevelopmentSection: typeof import('./src/components/AppError/AppErrorDevelopmentSection.vue')['default']
    AppErrorDevSection: typeof import('./src/components/AppError/AppErrorProductionSection.vue')['default']
